...
class _EditDetailsState extends State<EditDetails> {
  ...
  enterdetails(context, number, districtname, talukname, blockname, kbname,
      wardname) async {
    ...
    if (response.data['success']) {
      Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => HomePage(number: number, role: widget.role),
          ));
    } else {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) =>
                  EditDetails(number: number, role: widget.role)));
    }
  }
